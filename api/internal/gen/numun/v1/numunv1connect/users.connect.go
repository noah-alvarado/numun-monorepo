...
const (
	...
	UserServiceName = "numun.v1.UserService"
)
...
const (
	...
	UserServiceGetMeProcedure = "/numun.v1.UserService/GetMe"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/numun.v1.UserService/GetUser"
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_numun_v1_users_proto.Services().ByName("UserService").Methods()
	return &userServiceClient{
		...
		inviteStaff: connect.NewClient[v1.InviteStaffRequest, v1.InviteStaffResponse](
			httpClient,
			baseURL+UserServiceInviteStaffProcedure,
...
// GetUser calls numun.v1.UserService.GetUser.
...
// UpdateUser calls numun.v1.UserService.UpdateUser.
...
// InviteStaff calls numun.v1.UserService.InviteStaff.
func (c *userServiceClient) InviteStaff(ctx context.Context, req *connect.Request[v1.InviteStaffRequest]) (*connect.Response[v1.InviteStaffResponse], error) {
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	userServiceInviteStaffHandler := connect.NewUnaryHandler(
		UserServiceInviteStaffProcedure,
		svc.InviteStaff,
		connect.WithSchema(userServiceMethods.ByName("InviteStaff")),
		connect.WithHandlerOptions(opts...),
	)
...
func (UnimplementedUserServiceHandler) GetMe(context.Context, *connect.Request[v1.GetMeRequest]) (*connect.Response[v1.GetMeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("numun.v1.UserService.GetMe is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("numun.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("numun.v1.UserService.UpdateUser is not implemented"))
}
